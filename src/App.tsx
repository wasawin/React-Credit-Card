...
function App() {
  return (
    <>
      <main className=" flex justify-center items-center min-h-screen w-full   p-2 md:p-24">
        <div className="border border-black p-4 rounded-xl bg-gradient-to-r from-pink-500 to-rose-500 w-full md:w-96 h-96 group [perspective:1000px] overflow-hidden ">
          <article
